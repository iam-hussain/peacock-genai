...
const nextConfig = {
  // Skip type checking and ESLint during build to prevent memory issues
  // Type checking is still done by IDE and can be run separately with: npm run typecheck
