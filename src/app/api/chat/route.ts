...
import { getAgentGraph } from '@/core/agents/base-agent'
import { createTransactionTools } from '@/core/tools'
import { generateMessageId, MESSAGE_SENDER, MESSAGE_STATUS } from '@/utils/constants'
...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    const agentGraph = getAgentGraph(createTransactionTools())
